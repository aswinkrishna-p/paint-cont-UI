    ...
    return (
        <div className="mt-5 p-5 rounded-[22px] bg-white custom-box-shadow lg:w-[23rem] md:w-60 sm:w-30 mx-auto h-60 w-90 sm:h-48 md:h-56 lg:h-60 m-5 text-white">
            <div className="flex items-center mb-2">
                ...
                <h1 className="text-xl text-black font-semibold">  Membership</h1>
            </div>
            ...
            <button className="bg-gray-600 text-black py-2 px-4 rounded-full w-full flex items-center justify-center">

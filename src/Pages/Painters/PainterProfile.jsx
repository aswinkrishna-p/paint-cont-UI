              ...
              <div className="bg-white shadow-2xl rounded-lg p-6">
                <div className="flex flex-col items-start">
                  ...
                  <h1 className="text-xl font-bold">
                    {currentpainter.user.username}
                  </h1>
                  <p className="text-gray-700 placeholder:Age ">
                    Age:
                    {currentpainter.user.age
                      ? currentpainter.user.age
                      : "Add your Age"}
                  </p>
                  <p className="text-gray-700 placeholder:location ">
                    Location:
                    {currentpainter.user.location
                      ? currentpainter.user.location
                      : " Add your Location"}
                  </p>
                  <p className="text-gray-700 ">
                    Phone:
                    {currentpainter.user.phone
                      ? currentpainter.user.phone
                      : " Add your phone number here"}
                  </p>
                  <p className="text-gray-700 ">
                    Phone:
                    {currentpainter.user.experienceYears
                      ? currentpainter.user.experienceYears
                      : " Add your experience"}
                  </p>
                ...
                <div className="flex ">
                  ...
                  <ul className="flex ">
                    {currentpainter.user.specialised.map(
                      (speciality, index) => (
